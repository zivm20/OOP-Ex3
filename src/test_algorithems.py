...
class TestGraphAlgo(unittest.TestCase):
    ...
    def test_save(self):
        ...
        #add a new edge
        self.assertEqual(g_algo.get_graph().add_edge(1,2,5),False)
